...
class AddressController extends Controller
{
     ...
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request, UsersOrder $usersOrder)
    {
        $address = new Address();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->render('address/new.html.twig', array(
                'address' => $address,
                'form' => null,
                'message' => 'Dziekujemy za zlozenie zamowienia !\n Zamowienie zostanie dostarczone pod wskazany adres jak najszybciej'
            ));
        }
